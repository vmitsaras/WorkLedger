...
export const EMPLOYEE_TARGET_ACTIONS = Object.freeze([
...
export type EmployeeTargetAction = (typeof EMPLOYEE_TARGET_ACTIONS)[number];

export const ACCOUNT_TARGET_ACTIONS = Object.freeze([
...
export type AccountTargetAction = (typeof ACCOUNT_TARGET_ACTIONS)[number];

export const INSTALLATION_ACTIONS = Object.freeze([
  'DOMAIN_AUDIT_READ',
