...
| WL-802 | Implement eligible-reviewer changes request, approval, and lock | WL-801, WL-303 | Current-manager/HR-only scope, self-denial, account-first actor migration, transaction, snapshot, and audit tests | Not started |
