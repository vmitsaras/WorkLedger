...
| WL-1508B | Pass a fresh selection-v1 screen for known failures | WL-1508H, WL-1508I | Fresh 18/18 submission-actions/today-posted evidence for the implemented format; old-format 18/18 retained in report 167 | Reopened; no selection-v1 model case run |
...
| WL-1508C | Execute the complete strict replacement-model evaluation | WL-1508B | One uninterrupted 24-question × 3-locale × 3-repetition run records 216/216 for the exact qualified digest; artifact remains content free; any failure stops the sequence without gate closure | Failed 213/216; es-ES balance-summary duplicate references ×3; reports 168 and `docs/169-wl-1508c-duplicate-reference-diagnosis.md`; design complete in spec 0002; WL-1508I complete; fresh B required; no rerun |
