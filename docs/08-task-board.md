...
| WL-1508B | Run the qualified candidate through the known-failure regression screen | WL-1508A | All `submission-actions` and `today-posted` cases pass in all three locales and all three repetitions; content-free smoke artifact retained; no prompt, schema, validator, threshold, or native-fallback change | Ready |
