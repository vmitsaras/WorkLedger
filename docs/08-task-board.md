...
| WL-1508B | Run the qualified candidate through the known-failure regression screen | WL-1508A, WL-1508E, WL-1508F | `qwen2.5-coder:14b` stopped at 0/9 invalid tool-selection output; exact `qwen3-coder:30b` then stopped at 0/9 provider timeouts; WL-1508F is complete, so resume only for the exact qualified `qwen2.5-coder:14b` digest | Ready |
