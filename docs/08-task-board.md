...
| WL-1508 | Add the employee golden-question evaluation set, bounded traces, privacy/security tests, model-failure handling, and accessibility verification, then execute the local AI pilot sub-gate | WL-1507 | `docs/159-wl-1508-employee-local-ai-pilot-evaluation.md`; 24 questions × 3 locales × 3 repetitions; privacy, trace, degraded-provider, and accessibility evidence complete; exact-model gate remains open at 207/216 | In progress |
