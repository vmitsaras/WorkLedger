...
| WL-1508B | Pass a fresh screen after schema/completeness recovery | WL-1508J, WL-1508K | 9/9 submission-actions then 9/9 today-posted under the recovered exact configuration; report 171 preserves the earlier 18/18 | Failed first group 6/9; report 179: three Spanish pending-request action omissions; today-posted/C not run; report 180 diagnosis complete, action-coverage design next |
