...
| WL-210 | Execute full domain example suite and domain-calculation review | WL-200–WL-209 | All documented cases map to tests; review checklist complete | In progress |
