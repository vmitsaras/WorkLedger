...
| WL-1508B | Run the qualified candidate through the known-failure regression screen | WL-1508A, WL-1508E | `qwen2.5-coder:14b` stopped at 0/9 invalid tool-selection output; exact `qwen3-coder:30b` then stopped at 0/9 provider timeouts, six before a tool call and three after one tool execution; `today-posted` did not run and any further recovery requires an explicit bounded decision | Blocked |
