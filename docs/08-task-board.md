...
| WL-1404 | Translate shared UI, route titles and boundaries, authentication, application shell, navigation, profile, validation, dialogs, and announcements | WL-1402, WL-1403 | Shared and authenticated foundations render coherently in every locale | In progress |
