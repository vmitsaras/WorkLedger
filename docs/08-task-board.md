...
| WL-1402 | Implement per-account locale persistence, signed-out device preference, initial invitation locale, profile/auth selectors, and immediate language switching | WL-1401 | `docs/142-account-locale-preferences.md`; migration, API, integration, component, axe, browser, and bundle evidence | In progress — implementation and functional gates pass; blocked by `D-508` bundle decision |
