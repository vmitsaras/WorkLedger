...
| WL-1508K | Qualify an exact schema-enforcing provider | WL-1508J | Source-reviewed stable runtime/model, isolation and installation provenance, cold-start health, 18/18 synthetic challenges; fresh B/C afterward | Open; report 178: 0.33.3/qwen3.6 candidate and persistence prepared; Windows firewall consent canceled; no startup/inference |
