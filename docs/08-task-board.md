...
| WL-1508B | Pass a fresh selection-v1 screen for known failures | WL-1508H, WL-1508I | `docs/171-wl-1508b-selection-v1-screen.md`; 9/9 submission-actions then 9/9 today-posted, exact pinned controls, verified v2 artifacts and source hashes | Complete; 18/18; fresh C pending |
...
| WL-1508C | Execute the complete strict replacement-model evaluation | WL-1508B | One uninterrupted 24-question × 3-locale × 3-repetition run records 216/216 for the exact qualified digest; artifact remains content free; any failure stops the sequence without gate closure | Failed 213/216; es-ES balance-summary duplicate references ×3; reports 168 and `docs/169-wl-1508c-duplicate-reference-diagnosis.md`; design complete in spec 0002; WL-1508I complete and fresh B passed 18/18; new C pending |
