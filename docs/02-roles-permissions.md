...
| Request local model interpretation | `No`; the employee pilot closed without passing | `No`; unavailable in the accepted Phase 15 scope | `No`; unavailable in the accepted Phase 15 scope | `No`; unavailable in the accepted Phase 15 scope |
