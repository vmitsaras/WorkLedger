...
and `0.15.0` marks Phase 14 completion. `0.16.0` marks the completed deterministic,
provider-disabled Phase 15 release gate.
...
- **Current tested fixture path:** `0.9.0` → `0.16.0` through the cumulative migration set. The
  `WL-1516` rehearsal applies the Phase 9 checkpoint and all five later
