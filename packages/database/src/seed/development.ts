  ...
  await transaction.insert(approvedMonthlySnapshots).values([
    {
      approvalCycle: 1,
      approvedAt: '2026-02-03T09:00:00.000Z',
      approvedByAccountId: accountId(personaDefinitions[5]),
      approvedByAuthority: 'CURRENT_MANAGER',
      ...
      snapshot: {
        approvedRecord: {
          approvalCycle: 1,
          approvedAt: '2026-02-03T09:00:00.000Z',
          calculationEngineVersion: 'seed-engine-v1',
          periodVersion: 3,
          rows: [
            {
