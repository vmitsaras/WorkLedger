...
- [ ] `WL-1508B` Pass a fresh submission-actions and today-posted screen after J/K. Reopened for spec 0003; J/K complete. Report 179: fresh submission-actions failed 6/9, all three Spanish cases missing the required pending-request action; today-posted and C not run. Diagnose before another screen. Historical selection-v1 screen passed 9/9 then 9/9 on 2026-09-06 with unchanged controls/source hashes; preserved in `docs/171-wl-1508b-selection-v1-screen.md`. No retry followed the failed fresh screen.
