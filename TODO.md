...
- [ ] `WL-1508B` Pass a fresh submission-actions and today-posted screen after J/K. Reopened for spec 0003; J/K now complete and fresh B is next. Historical selection-v1 screen passed 9/9 then 9/9 on 2026-09-06 with unchanged controls/source hashes; preserved in `docs/171-wl-1508b-selection-v1-screen.md`. No fresh screen ran during J/K.
