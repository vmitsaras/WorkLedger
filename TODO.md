...
- [ ] `WL-1508K` Qualify exact installation/model/isolation using cold-start health and 18/18 synthetic challenges under spec 0003. Report 178: persistence repaired and tested; source-reviewed Ollama 0.33.3/qwen3.6 portable candidate prepared with verified archive/signature. Windows administrator consent for scoped outbound rules was canceled; no startup or inference ran. Apply/verify the prepared firewall helper before qualification. Fresh B then C required afterward.
