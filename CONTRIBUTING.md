...
Thank you for considering a contribution. WorkLedger has passed its repository-foundation gate and
is beginning its framework-independent domain engine; it is not a supported time-recording
application or a production-ready deployment. Proposals should match the active roadmap task and
the accepted product, domain, accessibility, security, and architecture contracts.
