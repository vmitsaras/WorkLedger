...
const args = pnpmScript
  ? [
      ...
      'packages/database/test/upgrade.integration.test.ts',
      ...
      'packages/database/test/performance.integration.test.ts',
      'apps/api/test/authentication.integration.test.ts',
      'apps/api/test/authorization.integration.test.ts',
      'apps/api/test/insight-service.integration.test.ts',
      'apps/api/test/employee-insight-handlers.integration.test.ts',
      'apps/api/test/manager-insight-service.integration.test.ts',
      'apps/api/test/hr-insight-service.integration.test.ts',
      'apps/api/test/system-insights.integration.test.ts',
      ...
      'apps/api/test/administration.integration.test.ts',
    ]
  : [
      'exec',
      'vitest',
