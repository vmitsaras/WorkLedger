...
> **Current phase progress: Phase 8 — 2 of 7 tasks complete**
...
binds warning acknowledgement to that exact source and freezes ordinary mutations. Phase 8 is in
progress; eligible-reviewer changes, approval, and lock are next (`WL-802`).
